!function() {
    var t, n, e, i = document.currentScript, o = {};
    function a(t, n, e) {
    ...
    function p() {
        "visible" === document.visibilityState && document.hasFocus() && 0 === u ? u = Date.now() : "hidden" !== document.visibilityState && document.hasFocus() || (s = v(),
        u = 0,
        w())
    }
    function v() {
    ...
    function g(i, v) {
        ...
        n = f(),
        e = h()),
        /^localhost$|^127(\.[0-9]+){0,2}\.[0-9]+$|^\[::1?\]$/.test(location.hostname) || "file:" === location.protocol)
    ...
    !function t(a) {
        o.endpoint = i.getAttribute("data-api") || new URL(i.src).origin + "/api/event",
        ...
        function(t) {
            function n(n) {
                n && e === location.pathname || (e = location.pathname,
                t("pageview"))
            }
            var e, i = function() {
                n(!0)
        ...
        for (var c = window.plausible && window.plausible.q || [], l = 0; l < c.length; l++)
            g.apply(this, c[l]);
        window.plausible = g,
        window.plausible.init = t,
        window.plausible.v = 31,
